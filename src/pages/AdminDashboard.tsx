...
const COLORS = ['#3b82f6', '#22c55e', '#7c3aed', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4'];
...
export const AdminDashboard: React.FC = () => {
  ...
  const renderDashboard = () => {
    ...
    const totalOrd = getTotalOrders();
    const totalProd = getTotalProducts();
    const pendingOrd = getPendingOrders();
    
    const revenueChange = totalRev > 0 ? 12.5 : 0;
    const ordersChange = totalOrd > 0 ? 8.3 : 0;
    const productsChange = totalProd > 0 ? -2.1 : 0;
    const pendingChange = pendingOrd > 0 ? -5.7 : 0;
      ...
      if (active && payload && payload.length) {
        return (
          <div className="admin__chart-tooltip">
            ...
            <p className="admin__chart-tooltip-value">
              Sales: ${payload[0].value?.toFixed(2) || 0}
            </p>
          </div>
        );
      }
        ...
        <div className="admin__stats-grid">
          <div className="admin__stat-card admin__stat-card--trend">
            ...
            <div className="admin__stat-content">
              <span className="admin__stat-value">${totalRev.toFixed(2)}</span>
          ...
          <div className="admin__stat-card admin__stat-card--trend">
            ...
            <div className="admin__stat-content">
              <span className="admin__stat-value">{totalOrd}</span>
          ...
          <div className="admin__stat-card admin__stat-card--trend">
            ...
            <div className="admin__stat-content">
              <span className="admin__stat-value">{totalProd}</span>
          ...
          <div className="admin__stat-card admin__stat-card--trend">
            ...
            <div className="admin__stat-content">
              <span className="admin__stat-value">{pendingOrd}</span>
